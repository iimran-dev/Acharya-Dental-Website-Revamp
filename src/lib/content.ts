...
export const SPECIALISTS = [
  {
    ...
    image: assetPath("/images/acharyadental/vijailakshmi-acharya.webp"),
    highlights: [
  ...
  },
  {
    ...
    image: assetPath("/images/acharyadental/varun-acharya.webp"),
    highlights: [
      "Prosthodontist & Implantologist",
...
export const SMILE_CASES = [
  ...
  {
    id: "case-2",
    title: "Full Arch Rehabilitation & Occlusal Harmony",
    tag: "Full Mouth Rehab",
    before: assetPath("/images/cases/case-2-before.jpg"),
    after: assetPath("/images/cases/case-2-after.jpg"),
    story: "Patient presented with broken and worn teeth causing difficulty in chewing and facial collapse.",
    treatment: "Comprehensive digital smile design, implant-supported units and ceramic crowns.",
    outcome: "Restored masticatory function, structural longevity, and refreshed facial aesthetics.",
  },
  {
    id: "case-3",
    title: "Dental Implant & Aesthetic Alignment",
    tag: "Implant Restorations",
    before: assetPath("/images/cases/case-1-before.jpg"),
    after: assetPath("/images/cases/case-2-after.jpg"),
    story: "Multiple missing posterior teeth with anterior spacing affecting smile confidence.",
    treatment: "Computer-guided implant placement with custom zirconia abutments and cosmetic contouring.",
    outcome: "Complete bite stability and a balanced, photogenic smile.",
  },
] as const;
